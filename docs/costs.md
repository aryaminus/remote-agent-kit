...
| [boat](https://boat.dev) | $20 minimum → ~555 h of 4 vCPU/8 GB, per-second, pause-when-stopped (resume loses running processes — their own advice is systemd) | Bursty use, one VM per agent, fork-as-branching |
